...
已为 EraseA12 增加专用 macOS 应用图标：深石墨底板上的设备轮廓被蓝色光带横向清除，
并用小红点提示不可逆操作。10 个标准 AppIcon 槽位、工程配置和回归测试已经完成，
通过 clean Release 构建及实际“关于 EraseA12”窗口检查，当前处于分支收尾阶段。
...
- 2026-07-08 17:38 图标分支验证：33/33 测试、clean Release、严格签名、universal 架构、
...
8. `EraseA12/EraseA12/Resources/Assets.xcassets/AppIcon.appiconset/` - 应用图标的 10 个标准槽位。
